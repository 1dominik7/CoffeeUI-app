...
import { ArrowLeftCircleIcon, HeartIcon, MinusIcon, PlusIcon, ShoppingBagIcon } from 'react-native-heroicons/solid'
  ...
  return (
      <View className="flex-1">
        ...
        <SafeAreaView className="space-y-4">
            ...
            className="flex-row mx-4 items-center rounded-3xl p-1 px-2 space-x-1 w-16 oapcity-90">
